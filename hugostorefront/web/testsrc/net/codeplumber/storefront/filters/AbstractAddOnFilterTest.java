 ...
 */
package net.codeplumber.storefront.filters;

import de.hybris.platform.servicelayer.config.ConfigurationService;
import net.codeplumber.storefront.filters.AcceleratorAddOnFilter.ExtensionAccessor;
...
public abstract class AbstractAddOnFilterTest
{
	...
	protected static final String STOREFRONT_NAME = "hugostorefront";
