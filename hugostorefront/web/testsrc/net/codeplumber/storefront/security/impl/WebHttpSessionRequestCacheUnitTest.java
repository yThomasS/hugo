...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hugostorefront/electronics/en",
						"https://electronics.local:9002/hugostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/hugostorefront/electronics/en",
						"https://electronics.local:9002/hugostorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hugostorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/hugostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/hugostorefront/electronics/en",
						"https://electronics.local:9002/hugostorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hugostorefront",
						"https://electronics.local:9002/hugostorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/hugostorefront",
						"https://electronics.local:9002/hugostorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/hugostorefront/electronics/en",
						"https://electronics.local:9002/hugostorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
