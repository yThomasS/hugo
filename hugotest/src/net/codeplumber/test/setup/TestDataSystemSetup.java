 ...
 */
package net.codeplumber.test.setup;
...
import net.codeplumber.test.constants.HugoTestConstants;
import net.codeplumber.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HugoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/hugotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/hugotest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/hugotest/import/cstickets.impex");
			...
			importImpexFile(context, "/hugotest/import/csquotes.impex");
		}
	}
}
