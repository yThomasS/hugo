 ...
 */
package net.codeplumber.fulfilmentprocess.test.jobs;
...
import net.codeplumber.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = HugoFulfilmentProcessConstants.ORDER_PROCESS_NAME;
