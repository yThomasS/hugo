 ...
 */
package net.codeplumber.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(HugoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HugoFulfilmentProcessConstants.PARENT_PROCESS);
