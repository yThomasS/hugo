 ...
 */
package net.codeplumber.core.constants;

/**
 * Global class for all HugoCore constants. You can add global constants for your extension into this class.
 */
public final class HugoCoreConstants extends GeneratedHugoCoreConstants
{
	public static final String EXTENSIONNAME = "hugocore";


	private HugoCoreConstants()
	{
		//empty
	}
