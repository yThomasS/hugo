 ...
 */
package net.codeplumber.core.job;
...
public class CustomersWithoutOrdersRetentionCronJobIntegrationTest extends ServicelayerTest
{
	...
	public void setup() throws Exception
	{
		...
		importCsv("/hugocore/import/common/cronjobs.impex", "utf-8");
		importCsv("/hugocore/test/testCustomersWithoutOrdersRetentionCronJob.impex", "utf-8");
